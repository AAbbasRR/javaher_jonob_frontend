...
const StoreModal = ({ open, setOpen, reload, setReload, setDefaultValue, defaultValue = null }) => {
	const {
		register,
		setError,
		setValue,
	...
	const onSubmit = (data) => {
		...
		if (editItemID === null) {
			axios
				.post("/store/manage/list_create/", data)
				.then((res) => {
					closeModal();
			...
			axios
				.put(`/store/manage/update_delete/?pk=${editItemID}`, data)
				.then((res) => {
					closeModal();
